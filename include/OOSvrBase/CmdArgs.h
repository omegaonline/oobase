...
namespace OOSvrBase
{
	...
	public:
		...
		typedef std::map<OOBase::string,OOBase::string,std::less<OOBase::string>,OOBase::CriticalAllocator<std::pair<OOBase::string,OOBase::string> > > resultsType;
	...
	private:
		...
		typedef std::multimap<OOBase::string,Option,std::less<OOBase::string>,OOBase::CriticalAllocator<std::pair<OOBase::string,Option> > > optsType;
		typedef std::map<OOBase::string,int,std::less<OOBase::string>,OOBase::CriticalAllocator<std::pair<OOBase::string,int> > > argsType;
